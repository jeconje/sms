...
<div class="collapse navbar-collapse navbar-ex1-collapse">
  <ul class="nav navbar-nav side-nav">
    ...
    <li class="active"><a href="<?php echo base_url(); ?>sms/calendarforstudent"><i class="icon32 icon-color icon-calendar"></i> Calendar</a></li>
  </ul>
      ...
      <ul class="nav navbar-nav navbar-right navbar-user">
        ...
        <li class="dropdown user-dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="<?php echo base_url(); ?>sms/changepassword"><i class="icon icon-color icon-key"></i> Change Password</a></li>
            <li class="divider"></li>
