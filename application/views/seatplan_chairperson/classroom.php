  ...
  <div>
    <div> 
      <button name = "submit" type="submit" class="btn btn-primary">Submit Attendance</button>
       <?php echo form_open("chairperson/classroom/$id_code"); ?>
    </div>
    <br>
  </div>
    </td>
               ...
               if($value['seat_number'] == 2){                              
                ...
                <div class="auto-style1" style="width: 70px; height: 8px">Absences: <?php echo $absent; ?></div>
                 ...
                 <div class="bs-example" align="right">
                  ...
                  <div class="bs-example" align="right">
                          <input name="attendanc2" type="radio" value=" " style="width: 25px"><span class="label label-success">..</span><br>
                          <input name="attendance2" type="radio" value="L" style="width: 25px"><span class="label label-warning">..</span><br>
                          <input checked="true"  name="attendance2" type="radio" value="A" style="width: 25px"><span class="label label-danger">..</span><br>
                          <div class="auto-style2">Status: <?php echo "With Violation"; ?></div>      
                  </div>  <?php }
        ...
        $absent = 0;
               ...
               if($value['seat_number'] == 41){                              
                ...
                <div class="auto-style1" style="width: 70px; height: 8px">Absences: <?php echo $absent; ?></div>
                 ...
                 <?php if($statuss == "Suspended" && $suspend_number == $value['student_number']){ ?>
                 <div class="bs-example" align="right">
                          <input name="attendance41" type="radio" value=" " style="width: 25px"><span class="label label-success">..</span><br>
                          <input name="attendance41" type="radio" value="L" style="width: 25px"><span class="label label-warning">..</span><br>
                          <input checked="true" name="attendance41" type="radio" value="A" style="width: 25px"><span class="label label-danger">..</span><br>
                          <div class="auto-style2">Status: <?php echo "Suspended"; ?></div>      
                  </div> <?php }                
                  ...
                  <div class="bs-example" align="right">
                          <input checked="true"  name="attendance41" type="radio" value=" " style="width: 25px"><span class="label label-success">..</span><br>
                          <input name="attendance41" type="radio" value="L" style="width: 25px"><span class="label label-warning">..</span><br>
        ...
        $absent = 0;
               ...
               if($value['seat_number'] == 42){                              
                ...
                <div class="auto-style1" style="width: 70px; height: 8px">Absences: <?php echo $absent; ?></div>
                 ...
                 <?php if($statuss == "Suspended" && $suspend_number == $value['student_number']){ ?>
                 <div class="bs-example" align="right">
                          <input name="attendance42" type="radio" value=" " style="width: 25px"><span class="label label-success">..</span><br>
                          <input name="attendance42" type="radio" value="L" style="width: 25px"><span class="label label-warning">..</span><br>
                          <input checked="true" name="attendance42" type="radio" value="A" style="width: 25px"><span class="label label-danger">..</span><br>
                          <div class="auto-style2">Status: <?php echo "Suspended"; ?></div>      
                  </div> <?php }                
                  ...
                  <div class="bs-example" align="right">
                          <input checked="true"  name="attendance42" type="radio" value=" " style="width: 25px"><span class="label label-success">..</span><br>
                          <input name="attendance42" type="radio" value="L" style="width: 25px"><span class="label label-warning">..</span><br>
        ...
        $absent = 0;
               ...
               if($value['seat_number'] == 43){                              
                ...
                <div class="auto-style1" style="width: 70px; height: 8px">Absences: <?php echo $absent; ?></div>
                 ...
                 <?php if($statuss == "Suspended" && $suspend_number == $value['student_number']){ ?>
                 <div class="bs-example" align="right">
                          <input name="attendance43" type="radio" value=" " style="width: 25px"><span class="label label-success">..</span><br>
                          <input name="attendance43" type="radio" value="L" style="width: 25px"><span class="label label-warning">..</span><br>
                          <input checked="true" name="attendance43" type="radio" value="A" style="width: 25px"><span class="label label-danger">..</span><br>
                          <div class="auto-style2">Status: <?php echo "Suspended"; ?></div>      
                  </div> <?php }                
                  ...
                  <div class="bs-example" align="right">
                          <input checked="true"  name="attendance43" type="radio" value=" " style="width: 25px"><span class="label label-success">..</span><br>
                          <input name="attendance43" type="radio" value="L" style="width: 25px"><span class="label label-warning">..</span><br>
        ...
        $absent = 0;
               ...
               if($value['seat_number'] == 44){                              
                ...
                <div class="auto-style1" style="width: 70px; height: 8px">Absences: <?php echo $absent; ?></div>
                 ...
                 <?php if($statuss == "Suspended" && $suspend_number == $value['student_number']){ ?>
                 <div class="bs-example" align="right">
                          <input name="attendance44" type="radio" value=" " style="width: 25px"><span class="label label-success">..</span><br>
                          <input name="attendance44" type="radio" value="L" style="width: 25px"><span class="label label-warning">..</span><br>
                          <input checked="true" name="attendance44" type="radio" value="A" style="width: 25px"><span class="label label-danger">..</span><br>
                          <div class="auto-style2">Status: <?php echo "Suspended"; ?></div>      
                  </div> <?php }                
                  ...
                  <div class="bs-example" align="right">
                          <input checked="true"  name="attendance44" type="radio" value=" " style="width: 25px"><span class="label label-success">..</span><br>
                          <input name="attendance44" type="radio" value="L" style="width: 25px"><span class="label label-warning">..</span><br>
        ...
        $absent = 0;
               ...
               if($value['seat_number'] == 45){                              
                ...
                <div class="auto-style1" style="width: 70px; height: 8px">Absences: <?php echo $absent; ?></div>
                 ...
                 <?php if($statuss == "Suspended" && $suspend_number == $value['student_number']){ ?>
                 <div class="bs-example" align="right">
                          <input name="attendance45" type="radio" value=" " style="width: 25px"><span class="label label-success">..</span><br>
                          <input name="attendance45" type="radio" value="L" style="width: 25px"><span class="label label-warning">..</span><br>
                          <input checked="true" name="attendance45" type="radio" value="A" style="width: 25px"><span class="label label-danger">..</span><br>
                          <div class="auto-style2">Status: <?php echo "Suspended"; ?></div>      
                  </div> <?php }                
                  ...
                  <div class="bs-example" align="right">
                          <input checked="true"  name="attendance45" type="radio" value=" " style="width: 25px"><span class="label label-success">..</span><br>
                          <input name="attendance45" type="radio" value="L" style="width: 25px"><span class="label label-warning">..</span><br>
        ...
        $absent = 0;
               ...
               if($value['seat_number'] == 46){                              
                ...
                <div class="auto-style1" style="width: 70px; height: 8px">Absences: <?php echo $absent; ?></div>
                 ...
                 <?php if($statuss == "Suspended" && $suspend_number == $value['student_number']){ ?>
                 <div class="bs-example" align="right">
                          <input name="attendance46" type="radio" value=" " style="width: 25px"><span class="label label-success">..</span><br>
                          <input name="attendance46" type="radio" value="L" style="width: 25px"><span class="label label-warning">..</span><br>
                          <input checked="true" name="attendance46" type="radio" value="A" style="width: 25px"><span class="label label-danger">..</span><br>
                          <div class="auto-style2">Status: <?php echo "Suspended"; ?></div>      
                  </div> <?php }                
                  ...
                  <div class="bs-example" align="right">
                          <input checked="true"  name="attendance46" type="radio" value=" " style="width: 25px"><span class="label label-success">..</span><br>
                          <input name="attendance46" type="radio" value="L" style="width: 25px"><span class="label label-warning">..</span><br>
        ...
        $absent = 0;
               ...
               if($value['seat_number'] == 47){                              
                ...
                <div class="auto-style1" style="width: 70px; height: 8px">Absences: <?php echo $absent; ?></div>
                 ...
                 <?php if($statuss == "Suspended" && $suspend_number == $value['student_number']){ ?>
                 <div class="bs-example" align="right">
                          <input name="attendance47" type="radio" value=" " style="width: 25px"><span class="label label-success">..</span><br>
                          <input name="attendance47" type="radio" value="L" style="width: 25px"><span class="label label-warning">..</span><br>
                          <input checked="true" name="attendance47" type="radio" value="A" style="width: 25px"><span class="label label-danger">..</span><br>
                          <div class="auto-style2">Status: <?php echo "Suspended"; ?></div>      
                  </div> <?php }                
                  ...
                  <div class="bs-example" align="right">
                          <input checked="true"  name="attendance47" type="radio" value=" " style="width: 25px"><span class="label label-success">..</span><br>
                          <input name="attendance47" type="radio" value="L" style="width: 25px"><span class="label label-warning">..</span><br>
        ...
        $absent = 0;
               ...
               if($value['seat_number'] == 48){                              
                ...
                <div class="auto-style1" style="width: 70px; height: 8px">Absences: <?php echo $absent; ?></div>
                 ...
                 <?php if($statuss == "Suspended" && $suspend_number == $value['student_number']){ ?>
                 <div class="bs-example" align="right">
                          <input name="attendance48" type="radio" value=" " style="width: 25px"><span class="label label-success">..</span><br>
                          <input name="attendance48" type="radio" value="L" style="width: 25px"><span class="label label-warning">..</span><br>
                          <input checked="true" name="attendance48" type="radio" value="A" style="width: 25px"><span class="label label-danger">..</span><br>
                          <div class="auto-style2">Status: <?php echo "Suspended"; ?></div>      
                  </div> <?php }                
                  ...
                  <div class="bs-example" align="right">
                          <input checked="true"  name="attendance48" type="radio" value=" " style="width: 25px"><span class="label label-success">..</span><br>
                          <input name="attendance48" type="radio" value="L" style="width: 25px"><span class="label label-warning">..</span><br>
