...
<div>
 <td rowspan="6" style="width: 50px"></td>
  ...
  <tr>
    ...
    <p align="right">1</p>
      <div class="auto-style1" style="width: 49px; height: 10px">Lates: <?php echo $value['attendance'] ?></div>
           <div class="auto-style1" style="width: 70px; height: 8px">Absences: <?php echo $value['attendance'] ?></div>
  ...
  <tr>
    ...
    <td>
    <input name="thirty_six" value="<?php echo $value['last_name'].' '.$value['first_name']; ?>" class="form-control" disabled = "true" style="width: 120px">
    <p align="right">36</p>  
      <div class="auto-style1" style="width: 49px; height: 10px">Lates: <?php echo $value['attendance'] ?></div>
          <div class="auto-style1" style="width: 70px; height: 8px">Absences: <?php echo $value['attendance'] ?></div>
          <div class="bs-example" align="right">
