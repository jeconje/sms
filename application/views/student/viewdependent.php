...
<div class="collapse navbar-collapse navbar-ex1-collapse">
  <ul class="nav navbar-nav side-nav">
    ...
    <li class="active"><a href="<?php echo base_url(); ?>sms/viewParents"><i class="icon32 icon-color icon-users"></i> Trackers</a></li>
         ...
         <br><br>
           <div class="table-responsive">
              <table class="table table-hover tablesorter">
                <thead>
                  <tr>
                    <th class="active"><center>Tracker</center></th>
                    <th class="active"><center>Profile Details</center></th>
                  </tr>
                </thead>                 
                <tbody align="center">     
                <?php foreach($viewTrackers as $value){?>            
                  <tr>
                    <td><img style="height:180px;width:244px" src="<?php echo $value['image_path']; ?>"></td> 
                    
                    <td>
                        &nbsp;&nbsp;&nbsp;Name: <b><?php echo $value['last_name'].', '.$value['first_name'].' '.$value['middle_name']; ?><br></b>
                        Contact Number: <b><?php echo $value['contact_number']; ?><br></b>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Email: <b><?php echo $value['email_address']; ?></b>
                    </td>                                        
                  </tr>
                  <?php } ?>            
                 </tbody>
