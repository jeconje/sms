...
<div class="collapse navbar-collapse navbar-ex1-collapse">
  <ul class="nav navbar-nav side-nav">
    ...
    <li class="active"><a href="<?php echo base_url(); ?>sms/viewGrades"><i class="icon32 icon-color icon-document"></i> Grades</a></li>
              ...
              <table class="table table-hover tablesorter">
                ...
                <tbody  align="center">                  
                  ...
                  <tr>                   
                    ...
                    <td>
                      <?php echo $value['prelim']; ?>
                    </td>   
                    <td>
                      <?php echo $value['midterm']; ?>
                    </td>   
                    <td>
                      <?php echo $value['finals']; ?>
                    </td>                 
                  </tr>
                  <?php }?>
