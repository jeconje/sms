                ...
                <tbody align="center">                  
                  ...
                  ?>    
                    ...
                    <tr>
                      ...
                      <td><a href='<?php echo base_url(); ?>parents/attendance_logs?id=<?php echo  base64_encode($value['student_number']); ?>'><button type="button" class="btn btn-primary">View Logs</button></td>
                    </tr>
                   <?php } ?>                </tbody>
              </table>
              <?php echo form_close(); ?>
