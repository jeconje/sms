...
<body>
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li><a href="<?php echo base_url(); ?>sdpc/add_account"><i class="icon32 icon-color icon-book-empty"></i> Add Account</a></li>
            <li class="active"><a href="<?php echo base_url(); ?>sdpc/calendar"><i class="icon32 icon-color icon-calendar"></i> Calendar</a></li>    
          </ul>
    ...
    <?php echo form_open("sdpc/edit_calendar"); ?>
              ...
              <table class="table table-hover tablesorter">
                  ...
                  <?php foreach ($info as $value) { $i++;
                    ...
                    <tr><input type="hidden" name='id<?php echo $i; ?>' value="<?php echo $value['calendar_id']; ?>" >
                      ...
                      <td><?php echo anchor('sdpc/deleteEvent?id='.$value['calendar_id'], 'Delete', 'name="delete" id="$value->calendar_id" class="btn btn-danger"'); ?></td>
                    </tr>
                  <?php } ?>                               
                  </tbody>
              </table>
